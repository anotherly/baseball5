...
<body>
 ...
 %> <input type="hidden" name="game_num" value="<%=gameList.get(i)%>">
			...
			<tr>
				<td>경기정보</td>
				<td><%=teamBean.getteamState(request)%> <%=teamBean.getpositionState(request)%>
					<%=teamBean.getplayerNameNoState(request)%> <%=teamBean.getplayerNameNoState1(request)%>
				</td>
			...
			<tr>
				<td colspan="2" align="center"><select id="teamId"
					...
					out.print("selected");
						...
						%>
				</select> <input type="hidden" name="playerId"
					value="<%=teamBean.getplayerNameNoState1(request)%>"> <input
					type="hidden" name="playerName"
					value="<%=teamBean.getplayerNameNoState(request)%>"></td>
			</tr>
