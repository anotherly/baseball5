...
public class Schedule implements SubControll {
	...
	public void execute() {
		...
		psvo = (PlayerStatVo) data.getDd3();
		psvo = (PlayerStatVo) data.getDd4();
//		schevo = (ScheduleVo) data.getDd3();
	...
	void list() {// HttpServletRequest request
		...
		//data.setDd3(scheRep.gameRegisterViewPlayerStatHome(schevo));
		//data.setDd4(scheRep.gameRegisterViewPlayerStatAway(schevo));
